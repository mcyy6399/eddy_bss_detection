...
# #################test data set##################################
data_train = xr.open_dataset('E:/term/mesoscale_eddy/sla_concat/eddy_sla6.nc')
data_train = data_train.transpose('day', 'lat', 'lon')

data_label = xr.open_dataset('E:/term/mesoscale_eddy/sla_concat//eddy_label6.nc')
...
print(type(x_train_new),type(x_train_label))
...
eddynet = models.load_model('../output/model_save/eddydan_onlysla.h5',custom_objects={'dice_coef_loss':dice_coef_loss,'dice_coef_anti':dice_coef_anti,'dice_coef_cyc':dice_coef_cyc,'mean_dice_coef':mean_dice_coef,'mean_iou':mean_iou,'InstanceNormalization': InstanceNormalization,'PAM':PAM,'CAM':CAM,'Zeros':tf.zeros_initializer(),'dice_coef_nn':dice_coef_nn})
...
savemat('../output/detection_result/eddydan_onlysla.mat', {'eddy': eddy,'evaluate':loss})
